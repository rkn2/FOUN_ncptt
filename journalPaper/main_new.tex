...
While cross-validation mitigates this risk, the limited sample size reduces statistical power to detect subtle effects, particularly for treatment variables where sample sizes for specific intervention types ranged from n=1 to n=4 (median n=2). 
