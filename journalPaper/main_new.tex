...
We note that while the model's absolute predictive power is limited by sample size and noise, the relative importance rankings provide valuable insights into which factors are most strongly associated with degradation.
