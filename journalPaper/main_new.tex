...
Elastic Net regression identified Wall Height and Cap Deterioration as the strongest predictors of overall degradation, alongside Out-of-Plane movement. Wall Height (standardized coefficient 43.0) demonstrates that geometric slenderness governs adobe vulnerability, while Cap Deterioration (54.5) reflects the dependence on water protection at the wall crest.
...
A supplemental geometric-only model (R² = 0.17) further confirmed that Wall Height is the dominant intrinsic risk factor.
