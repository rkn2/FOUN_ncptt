...
To mechanistically validate why condition-based predictors dominate despite adequate geometric proportions, a simplified overturning stability analysis was performed on the geometric subset. Assuming intact conditions and typical wind loading (25 psf, equivalent to 50 mph design wind per ASCE 7), only 8\% of walls exhibited factors of safety exceeding 1.5 against wind-induced overturning, indicating that the walls are already marginally stable in their as-built configuration. Critically, observed material loss from cap deterioration reduces the effective width and thereby the restoring moment; a 30\% reduction in cap width (observed in severely degraded walls) decreases the mean factor of safety by an additional 30\%, bringing many walls below the stability threshold. This demonstrates that while the walls possess adequate proportions to resist gravity loads, they operate near the margin of stability for lateral loads. Consequently, condition-based degradation (Cap Deterioration, Structural Cracking) becomes the critical parameter governing vulnerability, as these defects directly compromise an already limited safety margin. This mechanistically validates the statistical dominance of condition predictors in the Elastic Net model.
