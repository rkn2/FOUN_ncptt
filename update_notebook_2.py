 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Define Data from Tutorial 1 (Updated to match Manuscript)\n",
    "nscs = ['Structural Instability', 'Sill Deterioration', 'Surface Coating Degradation', 'Foundation Degradation']\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "**Scenario:** You are the project manager.\n",
    "\n",
    "**Interactive Task:**\n",
    "1.  **Set Your Budget:** How much money do you have?\n",
    "2.  **Set Unit Costs:** How much does each repair cost per wall?\n",
    "3.  **Allocate Repairs:** Use the sliders to decide how many walls to fix.\n",
    "4.  **Goal:** Maximize your **Total Priority Score** without going over budget!"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# --- BUDGET GAME WITH EDITABLE BUDGET & COSTS ---\n",
    "\n",
    "# Priorities (Benefit per wall treated)\n",
    "priorities = {'Fill': 90, 'Drip Edge': 60, 'Coat': 80, 'Sill': 70}\n",
    "\n",
    "# 1. Widget for Total Budget\n",
    "w_budget = widgets.IntText(value=10000, description='Total Budget ($):', style={'description_width': 'initial'}, layout=widgets.Layout(width='250px'))\n",
    "\n",
    "# 2. Widgets for Unit Costs\n",
    ...
    "}\n",
    "\n",
    "def update_budget_game(budget_limit, c_fill, c_drip, c_coat, c_sill, q_fill, q_drip, q_coat, q_sill):\n",
    "    # Gather inputs\n",
    ...
    "    plt.axvline(budget_limit, color='black', linestyle='--', label=f'Limit (${budget_limit:,})')\n",
    "    plt.xlim(0, max(budget_limit * 1.2, total_cost + 1000))\n",
    "    plt.legend()\n",
    "    plt.show()\n",
    "\n",
    "# Layout Construction\n",
    "rows = [widgets.HBox([w_budget])] # First row is budget\n",
...
with open('intervention_matrix_notebook.ipynb', 'w') as f:
